...
<library path="src\\assets\\Cows\\Project\\common\\89F2E80C-7FC8-CE39-D6CA-01805C449F19-SmalFont.swf" preload="true" generate="true" />
<library path="src\\assets\\Cows\\Project\\common\\F3CF6AE0-10E5-17E7-E542-AFF59EB4B159-SmallHiresFont.swf" preload="true" generate="true" />
...
public static function addEmbeddedAssets (__XApp:XApp):Void {
		...
		__XApp.getProjectManager ().addEmbeddedResource (
			"$Embedded\\89F2E80C-7FC8-CE39-D6CA-01805C449F19-SmalFont.swf" , SmalFont
		);
		__XApp.getProjectManager ().addEmbeddedResource (
			"$Embedded\\F3CF6AE0-10E5-17E7-E542-AFF59EB4B159-SmallHiresFont.swf" , SmallHiresFont
		);
